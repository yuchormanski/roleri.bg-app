...
// Get skater
skaterController.get(
  endpoints.get_skater_by_id,
  isUserLogged,
  preloader(getSkaterById, preloadOptions.getSkater),
  isOwner,
  async (req, res, next) => {
    try {
      const skaterId = req.params.skaterId;

      const skater = await getSkaterById(skaterId);
...
// Create skater
skaterController.post(
  endpoints.add_skater,
  isUserLogged,
  async (req, res, next) => {
    try {
...
// Update skater
skaterController.put(
  endpoints.edit_skater,
  isUserLogged,
  preloader(getSkaterById, preloadOptions.editSkater),
  isOwner,
  async (req, res, next) => {
    try {
...
// Delete skater
skaterController.delete(
  endpoints.delete_skater,
  isUserLogged,
  preloader(getSkaterById, preloadOptions.deleteSkater),
  isOwner,
  async (req, res, next) => {
    try {
      const skaterId = req.params.skaterId;
