  ...
  return (
    <div className={styles.container}>
                ...
                <div className={styles.content}>
                  ...
                  <div className={styles.actionContainer}>
                    <button
                      ...
                      onClick={() => onEditAge(ageOption)}
                    >
                      <LiaEditSolid />
                    </button>
                    <button
                      className={styles.actionBtn}
                      onClick={() => onDeleteAge(ageOption)}
                    >
                      <LiaTrashAlt />
                    </button>
                  </div>
      ...
      <div className={styles.addSkaterBtnContainer}>
        <button className={styles.addBtn} onClick={toggleAddAgeModalHandler}>
          {lang.addOptions}
        </button>
      </div>
      <section className={styles.description}>
        ...
        <p className={styles.info}>
          ...
          {lang.a_age_options_info_2}
        </p>
        <p className={styles.info}>
          <span>
            <GoIssueOpened />
          </span>
          {lang.a_age_options_info_3}
        </p>
      </section>

      {isShownAddAgeModal && (
        <AddAgeOptions onClose={toggleAddAgeModalHandler} />
      )}
      {isShownEditAgeModal && (
        <EditAgeOption
          onClose={toggleEditAgeModalHandler}
          ageData={selectedOptionData}
        />
      )}
      {isShownDeleteAgeModal && (
        <DeleteAgeOption
          onClose={toggleDeleteAgeModalHandler}
          ageData={selectedOptionData}
        />
      )}
    </div>
