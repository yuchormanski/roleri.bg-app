...
function RegisteredUser() {
    ...
    const { isFetching: isLessonsLoading, data: lessonData } = useGetAllLessonQueries();
    const { mutate, isPending: isAddBookingLoading } = useAddRegisteredBookQuery();
    ...
    return (
        <>
            {" "}
            {(isSkatersLoading || isOptionsLoading || isLessonsLoading || isAddBookingLoading) ? (
                <Spinner />
            ) : (
                                        ...
                                        <div className={styles.selectContainer}>
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {hasSkater(s._id) && optionData?.subscriptionData.map((subscription) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <option value="" hidden></option>
                                                    {hasSkater(s._id) && lessonData.map((lesson) => (
