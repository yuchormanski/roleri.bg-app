                        ...
                        {news.map(n => (
                            <article key={n._id} className={styles.article}>
                                <div className={styles.articleHeader}>
                                    ...
                                    <h2 className={styles.articleTitle}>{n.title}
                                        <span><FaRegFolderOpen /> {n.date}</span>
                                    </h2>
                                </div>
                                <div className={styles.articleBody}>
                                    <p>{n.content}</p>
                                    <a href={n.newsUrl} target="_blank" rel="noopener noreferrer" className={styles.linkPrimary}>
                                        {lang.details}
                                    </a>
                                </div>
                            </article>
